    ...
    <div className='flex flex-col items-center pt-20 h-screen w-full'>
        ...
        <form className='b-white w-full mt-4 p-2 rounded-lg shadow-lg'>
           <div className='flex flex-col space-y-6'>
            <label>Razao Social
            <input 
            type="text" placeholder="Nome completo" name="razaosocial" className="w-full px-4 py3 rounded-lg ring-red-200 border border-gray-300 focus:outline-none transition duration-300"
            /></label>
            <label>CNPJ
            <input 
            type="number" placeholder="CNPJ, somente números" name="cnpj" className="w-full px-4 py3 rounded-lg ring-red-200 border border-gray-300 focus:outline-none transition duration-300"
            /></label>
            <label>Endereço
            <input 

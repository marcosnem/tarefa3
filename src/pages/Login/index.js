    ...
    <div className='flex flex-col items-center pt-20 h-screen'>
        ...
        <form onSubmit={handleSubmit} className='b-white w-96 mt-6 p-4 rounded-lg shadow-lg'>
           <div className='flex flex-col space-y-6'>
            ...
            <button type="submit" className="w-full py-3 bg-yellow-300 text-black-300 focus:outline-none focus:ring-4 mt-6 rounded-lg transition duration-300">Entrar</button>
